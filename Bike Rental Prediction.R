...
#Load the librarires
lib = c("plyr","dplyr", "ggplot2","rpart","dplyr","DMwR","randomForest","usdm","corrgram","DataCombine")
lapply(X = lib,require, character.only = TRUE)
rm(lib)

#Read the csv file
day = read.csv(file = "https://s3-ap-southeast-1.amazonaws.com/edwisor-india-bucket/projects/data/DataN0103/day.csv", 
